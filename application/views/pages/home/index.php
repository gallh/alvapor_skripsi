		...
		<?php foreach($banners as $b) : ?>
			...
			<div class="carousel-item <?php if($no <= 1) { echo "active"; } ?>">
				...
				<div class="carousel-caption d-none d-md-block  <?= $b['text_color'] ?>">
					...
					<a href="<?= base_url('home/detail/' . $b['product_id']) ?>" class="btn btn-success badge-pill mt-3" style="width:100px">LIHAT</a>
				</div>
			</div>
		<?php endforeach ?> 
	</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mt-4">
				<div class="card" style="width: 16rem;">
					...
					<div class="card-body">
						...
						<a href="<?= base_url('home/detail/' . $game['id']) ?>" class="btn btn-outline-info btn-sm btn-block mt-3">Lihat</a>
					</div>
				</div>
			</div>
		<?php endforeach; ?>
